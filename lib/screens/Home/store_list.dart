...
class StoreList extends StatefulWidget {
  ...
  const StoreList({Key? key, this.storeList}) : super(key: key);
          ...
          SliverAppBar(
              ...
              child: Container(
                ...
                child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                "Est: " + widget.storeList["delivery_time"],
                                style: const TextStyle(
                                    color: Colors.orange,
                                    fontSize: 15,
                                    fontWeight: FontWeight.bold),
                      ...
                      Text(
                        widget.storeList["is_open"] ? "Open" : "Close",
                        overflow: TextOverflow.ellipsis,
                        style: TextStyle(
                          color: widget.storeList["is_open"] ? const Color(0xFF2ecc71)
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Image.network(
                getImageNetwork(widget.storeList["image"]),
                width: double.maxFinite,
                fit: BoxFit.fill,
              ),
            ),
